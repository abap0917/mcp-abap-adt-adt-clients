 ...
 *
 * Endpoint: PUT /sap/bc/adt/bo/behaviordefinitions/{name}/source?lockHandle={handle}
 *
...
export async function update(
  ...
  let url = `/sap/bc/adt/bo/behaviordefinitions/${encodeSapObjectName(params.name).toLowerCase()}/source?lockHandle=${encodeURIComponent(params.lockHandle)}`;
